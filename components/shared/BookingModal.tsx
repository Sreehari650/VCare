          ...
          >
            ...
            <div className="flex items-center justify-between p-8 pb-0">
              ...
              <button 
                ...
                className="w-full max-w-[2.5rem] h-10 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center hover:bg-red-100 hover:text-red-500 transition-colors"
              >
