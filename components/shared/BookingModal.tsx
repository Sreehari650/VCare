        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="flex items-center justify-between p-8 pb-0">
              ...
              <button 
                onClick={closeModal}
                className="w-10 h-10 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center hover:bg-red-100 hover:text-red-500 transition-colors focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
            ...
            >
              ...
              <button
                type="submit"
                className="mt-4 w-full h-14 bg-primary text-white font-bold text-lg rounded-2xl shadow-xl hover:shadow-none hover:translate-y-1 transition-all focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-primary"
              >
                Submit Request
              </button>
            </form>
