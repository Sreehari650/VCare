    ...
    >
      <div className="glass-panel w-full max-w-5xl rounded-full shadow-lg pointer-events-auto transition-all duration-300">
        <div className="px-4 md:px-6 py-2 flex items-center justify-between">
          ...
          <button
            type="button"
            className="md:hidden text-text-main dark:text-white flex items-center justify-center p-2 rounded-full hover:bg-gray-100 dark:hover:bg-white/10 cursor-pointer focus:outline-none focus:ring-2 focus:ring-primary"
