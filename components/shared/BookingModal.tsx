...
const BookingModal: React.FC = () => {
  ...
  const handleSubmit = (e: FormEvent) => {
    e.preventDefault();
    // In a real app, we would handle the submission here
    closeModal();
  };
            ...
            <div className="flex items-center justify-between p-8 pb-0">
              <div>
                <h3
                  ...
                  className="text-2xl font-display font-bold text-text-main dark:text-white"
                >
                  Let's Connect
                </h3>
            ...
            <form onSubmit={handleSubmit} className="p-8 flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-2">
                <label
                  ...
                  className="text-xs font-bold text-text-main dark:text-gray-300 uppercase tracking-wider pl-1"
                >
                  Name
                </label>
                <input 
              ...
              <button
                type="submit"
                className="mt-4 w-full h-14 bg-primary text-white font-bold text-lg rounded-2xl shadow-xl hover:shadow-none hover:translate-y-1 transition-all"
              >
                Submit Request
              </button>
            </form>
